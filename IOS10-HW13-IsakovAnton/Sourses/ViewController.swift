...
class ViewController: UIViewController {
    ...
    private var icons = ["airplane", "wifi", "bluetooth", "antenna.radiowaves.left.and.right", "antenna.radiowaves.left.and.right", "network"]
...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        default:
            ...
            //        cell.imageView?.image = iconImage
            //        cell.titleLabel.text = text
            //        cell.switchControl.isHidden = indexPath.row != 0
            //        return cell
        }
        return cell
    }
        func airplaneModeSwitchValueChanged(_ sender: UISwitch) {
